    ...
    <section className="my-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 justify-self-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-lg text-accent font-semibold">Customers</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <BsPeople className="text-6xl text-accent mb-3"></BsPeople>
          <p className="text-4xl font-bold">
          ...
          <p className="text-lg text-accent font-semibold">Annual revenue</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <BsPeople className="text-6xl text-accent mb-3"></BsPeople>
          <p className="text-4xl font-bold">
          ...
          <p className="text-lg text-accent font-semibold">Reviews</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <BsPeople className="text-6xl text-accent mb-3"></BsPeople>
          <p className="text-4xl font-bold">
          ...
          <p className="text-lg text-accent font-semibold">Tools</p>
        </div>
      </div>
    </section>
  );
